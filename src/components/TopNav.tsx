        ...
        <div className="flex items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-1 mx-auto">
            {navItems.map((item) => (
              <Link
                ...
                to={item.path}
                className={cn(
                  "px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 hover:translate-x-1",
                  isActive(item.path)
          ...
          <div className="md:hidden">
            <button
              ...
              className="p-2 rounded-lg text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-all duration-200 hover:translate-x-1"
            >
              {isMobileMenuOpen ? (
                <X className="w-5 h-5" />
              ) : (
            ...
            <div className="space-y-2">
              {navItems.map((item) => (
                <Link
                  ...
                  className={cn(
                    "block px-4 py-3 rounded-lg text-sm font-medium transition-all duration-200 hover:translate-x-1",
                    isActive(item.path)
                      ? "bg-blue-50 text-blue-700 border border-blue-200"
                      : "text-gray-600 hover:text-gray-900 hover:bg-gray-50"
                  )}
